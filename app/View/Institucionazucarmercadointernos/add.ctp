...
<br/>
<div class="InstitucionAzucarMercadoInterno form">
<h3>VENTAS DE AZÚCAR EN MERCADO INTERNO</h3>

<?php echo $this->Form->create('InstitucionAzucarMercadoInterno');?>
    <fieldset>
        ...
        echo $this->Form->input('precio', array('label' => 'Precio (Bs/Quintal de 46 kg)','style'=>'width:500px; height:30px;'));


        echo $this->Form->submit('Agregar Mercado Interno', array('class' => 'form-submit',  'title' => 'Presione aqui para agregar datos')); 
?>
    </fieldset>
