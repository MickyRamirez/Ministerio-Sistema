...
<?php echo $this->Form->create('SoyaProductorDerivado');?>
    <fieldset>
        ...
        echo $this->Form->hidden('id', array('value' => $this->data['SoyaProductorDerivado']['id']));
        ...
        echo $this->Form->input('soya_cliente_derivado_id', array( 'options' => $clientes,'empty' => '--Porfavor Selecione Cliente--','label' => 'Porfavor Seleccione a algun cliente de la lista' ));
