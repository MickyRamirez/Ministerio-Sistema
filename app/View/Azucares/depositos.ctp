...
<ul>
<li><?php echo $this->Html->link( "Existencias Depósito Ingenio",   array('action'=>'general') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Existencias Depósito Institución",   array('action'=>'generaluno') ); ?></li>
</ul>
<ul>
