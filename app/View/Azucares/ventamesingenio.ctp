...
<table>
	...
	<?php endif; ?>
			...
			<?php if($azucar['Grupo']['subcategoria']=='Ingenio Azucarero'):?>
				<td style="text-align: center;"><?php echo $this->Html->link("Año", array('action'=>'cano', $azucar['Azucar']['id'])); ?> </td>
				<td style="text-align: center;"><?php echo $this->Html->link("Mes", array('action'=>'cmes', $azucar['Azucar']['id'])); ?> </td>
        		<td style="text-align: center;"><?php echo $this->Html->link("Semestre", array('action'=>'csemestre', $azucar['Azucar']['id']));?>   </td>
			<?php endif;?>
