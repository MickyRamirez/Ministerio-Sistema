...
<table>
    <thead>
        <tr>
            ...
            <th>Institución alcohol exportación</th>
            <th>Institución alcohol mercado interno</th>
            <th>Institución azucar exportación</th>
            <th>Institución azucar mercado interno</th>
	        <th>Institución segun derecho propietario</th>
...
<?php endif; ?>
            ...
            <td style="text-align: center;"><?php echo $azucar['Perfil']['subciudad']; ?></td>
            ...
            if($azucar['Azucar']['aprobacion']==1){
                ...
                ?></td>
          <td>
            <?php echo $this->Html->link('Reporte', array('action' => 'reportinstitucionalcoholexportaciones', $azucar['Azucar']['id'])); ?>
        </td>
         <td>
            <?php echo $this->Html->link('Reporte', array('action' => 'reportinstitucionalcoholmercadosinternos', $azucar['Azucar']['id'])); ?>
        </td>
         <td>
            <?php echo $this->Html->link('Reporte', array('action' => 'reportinstitucionazucarexportaciones', $azucar['Azucar']['id'])); ?>
        </td>
          <td>
            <?php echo $this->Html->link('Reporte', array('action' => 'reportinstitucionazucarmercadosinternos', $azucar['Azucar']['id'])); ?>
        </td>
        <td>
            <?php echo $this->Html->link('Reporte', array('action' => 'reportinstitucionsegunderechospropietarios', $azucar['Azucar']['id'])); ?>
        </td>
          <td>
