...
<table>
	...
	<?php endif; ?>
			...
			<td style="text-align: center;"><?php echo $azucar['Perfil']['subdepartamento']; ?></td>
...
<h3>Acciones</h3>
<ul>
<li><?php echo $this->Html->link( "Control de Recepcion",   array('action'=>'recepcion') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Control de Entregas",   array('action'=>'entregas') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Control de Ventas",   array('action'=>'ventas') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Control de Produccion",   array('action'=>'produccion') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Control de Depositos",   array('action'=>'depositos') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Comparaciones",   array('action'=>'comparaciones') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Alarmas",   array('action'=>'alarmas') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Operaciones Administrativas",   array('action'=>'operaciones') ); ?></li>
</ul>
