...
<?php if($azucares){ ?>
<h3>Panel de Alarmas Instituciones Cañeras</h3>
<table>
    <thead>
        <tr>
			...
			<th><?php echo 'Azucar (TM)';?></th>
			<th><?php echo 'Alcohol (LT)';?></th>
			<th><?php echo 'Refinada (TM)';?></th>
			<th><?php echo 'Cruda (TM)';?></th>
			<th><?php echo 'Total';?></th>
			<th><?php echo 'Cachaza (TM)';?></th>
			<th><?php echo 'Malaza (TM)';?></th>
			<th><?php echo 'Bagaza (TM)';?></th>
