...
<ul>
<li> <?php echo $this->Html->link("Reporte", array('action'=>'reportevsemestreexportacioningenio', $this->data['Azucar']['id'])); ?> </li>
</ul>
<ul>
<li><?php 
...
echo $this->Form->hidden('id', array('value' => $this->data['Azucar']['id']));
 ?>
<h3>Panel de Ventas de Productos en Exportación</h3>
<?php
$TotalAzucarCruda=0;
