...
<table>
    <thead>
        <tr>
            ...
            <th>Control Técnico Cañero producción</th>
            <th>Control Técnico Cañero recepción</th>
        </tr>
    </thead>
    <tbody> 
<?php $count=0; ?>
...
<?php endif; ?>
        ...
        <td><?php echo $this->Html->link('Reporte', array('action' => 'reportctcproducciones', $azucar['Azucar']['id'])); ?>
        </td>
         <td><?php echo $this->Html->link('Reporte', array('action' => 'reportctcrecepciones', $azucar['Azucar']['id'])); ?>
        </td>
