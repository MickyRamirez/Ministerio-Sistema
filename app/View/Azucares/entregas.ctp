...
<?php if($azucares){ ?>
<h3>Panel de Administración de Entregas Azucareras</h3>
<table>
    <thead>
        <tr>
	...
	<?php endif; ?>
			...
			<?php if(($azucar['Grupo']['subcategoria'])=='Ingenio Azucarero'): 
						?>
						<td><?php echo $this->Html->link("Año", array('action'=>'canoingenio', $azucar['Azucar']['id'])); ?> </td> 
						<td><?php echo $this->Html->link("Semestre", array('action'=>'csemestreingenio', $azucar['Azucar']['id'])); ?> </td>
						<td><?php echo $this->Html->link("Mes", array('action'=>'cmesingenio', $azucar['Azucar']['id'])); ?> </td>
						<?php
				  else: 
				  		?>
						<td><?php echo $this->Html->link("Año", array('action'=>'canoctc', $azucar['Azucar']['id'])); ?> 
						</td>
						<td><?php echo $this->Html->link("Semestre", array('action'=>'csemestrectc', $azucar['Azucar']['id'])); ?> </td>
						<td><?php echo $this->Html->link("Mes", array('action'=>'cmesctc', $azucar['Azucar']['id'])); ?> </td>
			<?php endif; ?> 
