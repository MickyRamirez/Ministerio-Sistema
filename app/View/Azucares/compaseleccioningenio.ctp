...
<?php echo $this->Form->create('Azucar', array('url'=>array('controller'=>'azucares', 'action'=>'compainformeingenio'), $this->request->data['Azucar']['id'])); ?>
<table valign="top">
...
<h3>Acciones</h3>
<ul>
<li><?php echo $this->Html->link( "Volver Atras",   array('action'=>'comparaciones') ); ?></li>
</ul>
<ul>
<li><?php 
