...
<div class="soyaproductorcompras form">
 <h3>Registro de Exportación Mensual</h3>
<?php echo $this->Form->create('SoyaProductorExportacion');?>
    <fieldset>

        <?php 
        echo $this->Form->hidden('id', array('value' => $this->data['SoyaProductorExportacion']['id']));
        echo $this->Form->input('operacion', array('type' => 'hidden', 'value'=>'Exportacion'));
