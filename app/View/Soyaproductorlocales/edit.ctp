...
<div class="soyaproductorcompras form">
 <h3>Registro de Venta Local Mensual</h3>
<?php echo $this->Form->create('SoyaProductorLocal');?>
    <fieldset>

        <?php 
        echo $this->Form->hidden('id', array('value' => $this->data['SoyaProductorLocal']['id']));
        echo $this->Form->input('operacion', array('type' => 'hidden', 'value'=>'Venta Local'));
