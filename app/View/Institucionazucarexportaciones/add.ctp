...
<?php echo $this->Form->create('InstitucionAzucarExportacion');?>
    <fieldset>
        ...
        echo $this->Form->submit('Agregar Exportacion', array('class' => 'form-submit',  'title' => 'Presione aqui para agregar datos')); 
?>
    </fieldset>
