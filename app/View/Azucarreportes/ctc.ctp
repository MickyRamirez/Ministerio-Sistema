...
<?php endif; ?>
        ...
        <td><?php echo $this->Html->link('Reporte', array('controller' => 'Reportectcproducciones', 'action' => 'export_xls', $azucarreporte['Azucarreporte']['id'])); ?>
        </td>
         <td><?php echo $this->Html->link('Reporte', array('controller' => 'Reportectcrecepciones', 'action' => 'export_xls', $azucarreporte['Azucarreporte']['id'])); ?>
        </td>
