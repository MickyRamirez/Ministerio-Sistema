...
<?php endif; ?>
            ...
            if($azucarreporte['Azucarreporte']['aprobacion']==1){
                ...
                ?></td>
        <td>
            <?php echo $this->Html->link('Reporte', array('controller' => 'Reportealcoholexportaciones', 'action' => 'export_xls', $azucarreporte['Azucarreporte']['id'])); ?>
        </td>
         <td>
            <?php echo $this->Html->link('Reporte', array('controller' => 'Reportealcoholmercadointernos', 'action' => 'export_xls', $azucarreporte['Azucarreporte']['id'])); ?>
        </td>
         <td>
            <?php echo $this->Html->link('Reporte', array('controller' => 'Reporteazucarexportaciones', 'action' => 'export_xls', $azucarreporte['Azucarreporte']['id'])); ?>
        </td>
        <td>
            <?php echo $this->Html->link('Reporte', array('controller' => 'Reporteazucarmercadointernos', 'action' => 'export_xls', $azucarreporte['Azucarreporte']['id'])); ?>
        </td>
          <td>
            <?php echo $this->Html->link('Reporte', array('controller' => 'Reporteazucarentregas', 'action' => 'export_xls', $azucarreporte['Azucarreporte']['id'])); ?>
        </td>
           <td>
            <?php echo $this->Html->link('Reporte', array('controller' => 'Reporteingenioproducciones', 'action' => 'export_xls', $azucarreporte['Azucarreporte']['id'])); ?>
        </td>
        <td>
            <?php echo $this->Html->link('Reporte', array('controller' => 'Reporteingeniorecepciones', 'action' => 'export_xls', $azucarreporte['Azucarreporte']['id'])); ?>
        </td>
