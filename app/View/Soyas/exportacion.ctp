...
<?php if($soyas){ ?>
<h3>Panel de Control de Exportaciones de Productores de Oleaginosas</h3>
<table>
    <thead>
        <tr>
	...
	<?php endif; ?>
		...
		<td>
        <?php echo $this->Html->link("Filtro", array('action'=>'exportfiltro', $soya['Soya']['id'])); ?>
        </td>
		<td>
        <?php echo $this->Html->link("Año", array('action'=>'exportano', $soya['Soya']['id'])); ?>  
        </td>
        <td>
        <?php echo $this->Html->link("Mes", array('action'=>'exportmes', $soya['Soya']['id'])); ?>  
        </td>
        <td>
        <?php echo $this->Html->link("Semestre", array('action'=>'exportsemestre', $soya['Soya']['id'])); ?>  
        </td>
