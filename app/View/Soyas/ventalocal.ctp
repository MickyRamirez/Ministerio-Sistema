...
<h3>Panel de Control <br/> 
	Venta Local Productores de Oleaginosas	</h3>
<table>
    <thead>
        <tr>
		...
		<th><?php echo $this->Paginator->sort('Acciones', 'Reporte por Filtros');?></th>
	...
	<?php endif; ?>
		...
		<td>
        <?php echo $this->Html->link("Filtro", array('action'=>'ventafiltro', $soya['Soya']['id'])); ?>
        </td>
		<td>
        <?php echo $this->Html->link("Año", array('action'=>'localano', $soya['Soya']['id'])); ?>  
        </td>

        <td>
        <?php echo $this->Html->link("Mes", array('action'=>'localmes', $soya['Soya']['id'])); ?>  
        </td>
        <td>
        <?php echo $this->Html->link("Semestre", array('action'=>'localsemestre', $soya['Soya']['id'])); ?> 
        </td>
