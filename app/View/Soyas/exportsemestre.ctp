...
<ul>
<li><?php echo $this->Html->link("Reporte", array('action'=>'reportepsemestre', $this->data['Soya']['id'])); ?></li>
</ul>
<ul>
<li><?php 
...
echo $this->Form->hidden('id', array('value' => $this->data['Soya']['id']));
 ?>
<h3>Panel de Exportaciones Semestrales de Productores de Oleaginosas</h3>
<?php
