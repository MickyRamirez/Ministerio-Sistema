...
<table>
	...
	<?php endif; ?>
		...
		<td>
        <?php echo $this->Html->link("Filtro", array('action'=>'produccionfiltro', $soya['Soya']['id'])); ?> 
        </td>
		<td>
        <?php echo $this->Html->link("Año", array('action'=>'produccionano', $soya['Soya']['id'])); ?> 
        </td>
        <td>
        <?php echo $this->Html->link("Mes", array('action'=>'produccionmes', $soya['Soya']['id'])); ?>  
        </td>
        <td>
        <?php echo $this->Html->link("Semestre", array('action'=>'produccionsemestre', $soya['Soya']['id'])); ?>  
        </td>
