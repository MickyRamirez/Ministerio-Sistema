...
<table>
    <thead>
		...
		<th><?php echo $this->Paginator->sort('Acciones', 'Régimen');?></th>
		<th><?php echo $this->Paginator->sort('Acciones', 'Régimen Mes');?></th>
		<th><?php echo $this->Paginator->sort('Acciones', 'Campaña');?></th>
	...
	<?php endif; ?>
		...
		<td><?php echo $this->Html->link("Filtros", array('action'=>'reporteseleccion', $soya['Soya']['id'])); ?> </td>
		<td><?php echo $this->Html->link("Campaña", array('action'=>'regimenmes', $soya['Soya']['id'])); ?>  </td>
		<td><?php echo $this->Html->link("Por Mes", array('action'=>'regimenpormes', $soya['Soya']['id'])); ?> </td>
		<td><?php echo $this->Html->link("Campaña", array('action'=>'filtrocampana', $soya['Soya']['id'])); ?> </td>

		<td><?php echo $this->Html->link("Año", array('action'=>'cano', $soya['Soya']['id'])); ?> </td>

		<td><?php echo $this->Html->link("Mes", array('action'=>'cmes', $soya['Soya']['id'])); ?> </td>

        <td><?php echo $this->Html->link("Semestre", array('action'=>'csemestre', $soya['Soya']['id']));?>   </td>
...
<ul>
<li><?php echo $this->Html->link( "Régimen de Soya por Campaña",   array('action'=>'filtroregimengeneral') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Régimen de Soya por Mes",   array('action'=>'regimengeneralmes') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Filtro de Régimen",   array('action'=>'seleccionregimen') ); ?></li>
</ul>
