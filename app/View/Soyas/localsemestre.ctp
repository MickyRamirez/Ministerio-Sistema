...
<h3>Acciones</h3>
<ul>
<li><?php echo $this->Html->link( "Volver Atras",   array('action'=>'ventalocal') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link("Reporte", array('action'=>'reportevlsemestre', $this->data['Soya']['id'])); ?></li>
</ul>
<ul>
<li><?php 
...
echo $this->Form->hidden('id', array('value' => $this->data['Soya']['id']));
 ?>
<h3>Panel de Ventas Locales Semestrales <br/> Productores de Oleaginosas</h3>
<?php
...
<table>
    <thead>
		...
		<th><?php echo 'CASCARILLA DE GIRASO';?> </th>		
