...
<h3>Panel de Control <br/>
	Compra y Producción <br/>
	Empresas Oleaginosas</h3>
<table>
    <thead>
        <tr>
	...
	<?php endif; ?>
        ...
        <td>
        <?php echo $this->Html->link("Mes", array('action'=>'alarmacompraventa', $soya['Soya']['id'])); ?> 
        </td>
...
<ul>
<li><?php echo $this->Html->link( "Control de Soya",   array('action'=>'alarmasoya') ); ?></li>
</ul>
<ul>
