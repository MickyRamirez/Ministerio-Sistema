...
<ul>
<li><?php echo $this->Html->link("Reporte", array('action'=>'reporteregimenmes', $this->data[0]['Perfil']['user_id'])); ?> </li>
</ul>
<ul>
<li><?php 
...
<h3>Panel de Compra de Productores de Oleaginosas por Régimen</h3>
<?php
...
<table>
	...
	<?php for ($i=1; $i <= 2 ; $i++) { ?>
		<tr><th><?php 
		$tar='';
		if ($i==2) { echo 'CAMPAÑA DE INVIERNO';
			$tar='INVIERNO';
		}
		if ($i==1) { echo 'CAMPAÑA DE VERANO'; 
			$tar='VERANO';
		}
		?></th>
