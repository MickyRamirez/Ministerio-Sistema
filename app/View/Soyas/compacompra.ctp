...
<ul class="mi-menu">
  <li>
  	<?php echo $this->Html->link( "Comparaciones",   array('action'=>'compopcion',  $this->data['Soya']['id']) ); ?>
    
    <!-- <ul>
      <li>
      <?php echo $this->Html->link( "Anual",   array('action'=>'compaanual', $this->data['Soya']['id'])); ?></li>
      <li><?php echo $this->Html->link( "Semestre",   array('action'=>'compasemestre', $this->data['Soya']['id'])); ?></li>
      <li><?php echo $this->Html->link( "Mensual",   array('action'=>'compames', $this->data['Soya']['id'])); ?></li>
    </ul> !--> 
  </li>  
</ul> 
