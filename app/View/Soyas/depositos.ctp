...
<?php if($soyas){ ?>
<h3>Panel de Administración de Almacenes</h3>
<table>
    <thead>
        <tr>
...
<ul>
<li><?php echo $this->Html->link( "Existencias en Almacenes",   array('action'=>'general') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Almacenes Producción",   array('action'=>'alarma') ); ?></li>
</ul>
<ul>
