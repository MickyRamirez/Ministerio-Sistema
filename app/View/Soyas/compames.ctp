...
<ul>
<li><?php echo $this->Html->link( "Anual",   array('action'=>'compaanual', $this->data['Soya']['id'])); ?></li>
</ul>
<ul>
...
<li><?php echo $this->Html->link( "Grafica",   array('action'=>'graficas', $this->data['Soya']['id'])); ?></li>
</ul>
<ul>
<li><?php 
