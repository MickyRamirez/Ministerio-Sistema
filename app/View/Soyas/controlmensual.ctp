...
<?php if($soyas){ ?>
<h3>Panel de Administración de Productores de Soya mensual</h3>
<table>
    <thead>
        <tr>
...
<ul>
<li><?php echo $this->Html->link( "Mensual Producción",   array('action'=>'produccion') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Mensual Exportación",   array('action'=>'exportacion') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Mensual Venta Local",   array('action'=>'ventalocal') ); ?></li>
</ul>
<ul>
<li><?php echo $this->Html->link( "Mensual Compra Grano",   array('action'=>'compragrano') ); ?></li>
</ul>
<ul>
