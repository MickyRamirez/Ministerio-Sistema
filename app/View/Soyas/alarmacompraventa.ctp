...
<ul>
<li> <?php echo $this->Html->link("Reporte", array('action'=>'reportealarmacompraventa', $this->data['Soya']['id'])); ?></li>
</ul>
<ul>
<li><?php 
...
<h3>Panel de Alarmas <br/> 
	Productores de Oleaginosas <br/> 
	Compra es mayor a la producción</h3>
<?php
...
<table>
    <thead>
		...
		<th><?php echo 'TOTAL DE PRODUCCIÓN GIRASOL';?> </th>

		<th><?php echo 'COMPARACIÓN DE GRANO Y PRODUCCIÓN DE SOYA';?> </th>
		<th><?php echo 'COMPARACIÓN DE GRANO Y PRODUCCIÓN DE GIRASOL';?> </th>
