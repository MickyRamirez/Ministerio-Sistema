...
<?php echo $this->Form->create('Soya', array('action' => 'reportecompacompra', $this->request->data['Soya']['id'])); ?>
<table valign="top">
	...
	<?php	
    echo $this->Form->submit('Generar reporte', array('class' => 'form-submit',  'title' => 'Presione aqui generar la comparacion seleccionada')); 
?>
</div>
