...
<h3>Acciones</h3>
<ul>
<li><?php echo $this->Html->link( "Volver Atras",   array('action'=>'compaventa', $this->data['Soya']['id'])); ?></li>
</ul>
...
<?php } ?>
<?php echo $this->html->link($this->html->image("reporte.jpg"), array('controller'=>'soyas', 'action' => 'graficas', $this->data['Soya']['id']), array('escape' => false));?>
</div>